<template>
    <div class="max-w-[600px] mx-auto container">
    ...
    <ProgressBar :value="65" color="#E8630A" lean="Right" text="Author view's are Right" height="20"/>
      ...
      <div class=" p-3 dark:bg-black dark:text-white rounded-lg flex flex-col items-center justify-between md:flex-row gap-3  ">
